...
static struct disk {
  /// \brief the virtio driver and device mostly communicate through a set of
  ...
  /// \brief the first region of pages[] is a set (not a ring) of DMA
  ...
  /// \brief next is a ring in which the driver writes descriptor numbers
  ...
  /// \brief finally a ring in which the device writes descriptor numbers that
  ...
  /// \brief is a descriptor free?
  char free[NUM];
  /// \brief we've looked this far in used[2..NUM].
  uint16 used_idx;

  /// \brief track info about in-flight operations,
...
/// \brief free a chain of descriptors.
